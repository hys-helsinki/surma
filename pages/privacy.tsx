  ...
  return (
    ...
    <Box sx={{paddingTop: "5px"}}>
      ...
      <p>Käyttäjän tiedot kerätään kahdella lomakkeella ja evästeillä. 
        Ensimmäisen lomakkeen käyttäjä täyttää ilmoittautuessaan salamurhaturnaukseen Surmassa (jatkossa “ilmoittautumislomake”) ja toisen lomakkeen käyttäjä täyttää ilmoittautumisen jälkeen Surmassa (jatkossa “osallistumislomake”). 
        Turnaukseen ilmoittautuminen ja osallistuminen on vapaaehtoista. 
        Evästeet käyttäjästä luodaan lomakkeiden täytön ja Surman käytön yhteydessä.</p>
      ...
      <li>puhelinnumero</li>
      <li>suostumus tietojen käsittelystä tämän tietosuojailmoituksen mukaisesti ja</li>
      ...
      <ul>
        ...
        <li>turvallisuushuomiot (esim. pelin ulkopuolelle rajatut ajat ja paikat)</li>
        <li>muut vapaavalintaiset tiedot (esim.kulkuneuvot)</li>
        <li>suostumus tietojen käsittelystä tämän tietosuojailmoituksen mukaisesti ja</li>
        <li>aikaleima, milloin käyttäjä täytti lomakkeen.</li>
      </ul>
    <p>Lisäksi Surma kerää seuraavia evästeitä käyttäjäkohtaisesti käyttäjän käyttäessä Surmaa:</p>
    <ul>
      <li>aikaleima, milloin käyttäjä on viimeksi kirjautunut Surmaan ja</li>
      <li>aikaleima, milloin käyttäjä on viimeksi muokannut tietojaan Surmassa.</li>
    </ul>
    <h2>Perusteet ja käyttötarkoitukset</h2>
    <p>Ylläpitäjät käyttävät seuraavia tietoja Euroopan tietosuoja-asetusta varten (yleinen etu):</p>
    <ul>
      <li>etu- ja sukunimi</li>  
      <li>sähköpostiosoite</li>  
      <li>puhelinnumero</li>  
      <li>suostumus tietojen käsittelystä ja</li> 
      <li>aikaleimat ilmoittautumis- ja osallistumislomakkeen täytöistä.</li>
    </ul>
    <p>Ylläpitäjät ja tuomaristo käyttävät seuraavia tietoja Surman ja salamurhaturnauksen ylläpitämiseen (oikeutettu etu):</p>
    <ul>
    <li>aikaleima käyttäjän edellisestä kirjautumisesta Surmaan ja</li>  
    <li>aikaleima edellisestä kerrasta, jolloin käyttäjä on muokannut tietojaan Surmassa.</li>
    </ul>
    <p>Tuomaristo käyttää seuraavia tietoja salamurhaturnauksen sisäiseen ja käyttäjäkohtaiseen viestintään (oikeutettu etu):</p>
    <ul>
      <li>etu- ja sukunimi</li>  
      <li>sähköpostiosoite ja</li>  
      <li>puhelinnumero.</li>
    </ul>
    <p>Tuomaristo käyttää seuraavia tietoja salamurhaturnauksen avoimeen ja julkiseen viestintään turnauksen tapahtumasivulla (oikeutettu etu):</p>
    <ul>
      <li>turnauskohtainen anonyymi peitenimi.</li>
    </ul>
    <p>Tuomaristo ja muut pelaajat käyttävät seuraavia tietoja käyttäjän tunnistamiseen turnauksessa sekä turnauksen pelaamista ja ylläpitämistä varten (oikeutettu etu):</p>
    <ul>
      <li>etu- ja sukunimi</li>  
      <li>pituus</li>  
      <li>omakuva</li>  
      ...
      <li>vapaa kuvaus silmistä</li>  
      <li>vapaa kuvaus hiuksista ja</li>  
      <li>turvallisuushuomiot (esim. pelin ulkopuolelle rajatut ajat ja paikat) ja</li>  
      <li>muut vapaavalintaiset annetut tiedot (esim. kulkuneuvot).</li>
    </ul>
    <h2>Säilytysaika</h2>
    <p>Käyttäjän turnauskohtainen anonyymi peitenimi julkaistaan turnauksen tapahtumasivulla toistaiseksi, joka on erillinen nettisivu Surmasta. 
      Kaikkea muuta Surmassa kerättyä dataa käytetään vain salamurhaturnauksen ajan ja se tuhotaan salamurhaturnauksen päätyttyä.</p>
    <h2>Käyttäjän oikeudet</h2>
      ...
      <p>Käyttäjän antama data oletetaan oikeaksi sellaisenaan. 
        Tuomaristo voi halutessaan varmistaa käyttäjältä tietojen oikeellisuuden. 
        Käyttäjä voi myös itse muokata osallistumislomakkeen tietoja Surmassa peitenimeä lukuun ottamatta. 
        Muissa tapauksissa käyttäjä voi ottaa yhteyttä rekisterin käsittelijöihin.</p>
      <h3>Oikeus tulla unohdetuksi</h3>
      <p>Käyttäjä voi tulla unohdetuksi milloin tahansa osoittamalla pyynnön rekisterin käsittelijöille. 
        Jos käyttäjän data poistetaan, myös käyttäjän turnausosallistuminen peruuntuu.</p>
      <h3>Oikeus vastustaa tai rajoittaa tietojen käsittelyä</h3>
      <p>Käyttäjä voi vastustaa tai rajoittaa henkilötietojensa käsittelyä niin halutessaan tässä tietosuojailmoituksessa mainittuihin tarkoituksiin osoittamalla pyynnön rekisterin käsittelijöille. 
    ...
    <p>Surmassa kerättyjä tietoja siirretään muille käyttäjille vain siinä laajuudessa, kuin he tarvitsevat voidakseen osallistua turnaukseen.</p>
    <p>Käyttäjän tietoja säilytetään Surman PostgreSQL-tietokannassa, jota ylläpidetään ilmaiseksi Vercelillä. Vercel on amerikkalaisomisteinen yhtiö. Surman tietokantapalvelin sijaitsee Washingtonissa, USA:ssa.</p>
    <p><a href="https://vercel.com/legal/privacy-policy">Vercelin, Surman tietokantapalvelimen tarjoajan, tietosuojailmoitus englanniksi</a>.</p>
    <p>Surman käyttöliittymän palvelinta ylläpidetään suomalaisomisteisen Suncometin kautta. Suncometin palvelimet ovat ympäri maailmaa, mutta kotisivumme on ensisijaisesti C1-palvelimella. 
      <a href="https://suncomet.fi/osoitteet/">Suncometin, Surman käyttöliittymän ja kotisivujen ylläpidon tarjoajan, palvelintiedot suomeksi</a>.</p>
    ...
    <li>väärinkäytöksen, turvallisuusriskin tai teknisen ongelman havaitsemiseen, estämiseen tai käsittelemiseen.</li>
    </ul>
    <h2>Yhteystiedot</h2>
    <p>Kysymykset rekisteristä ja Surman vikatilanteista ohjataan Surman kehittäjille. Kysymykset turnauksesta ohjataan tuomaristolle.</p>
    <ul>
    <li>Rekisterinpitäjä</li>
      <ul>
        ...
        <li>Yhdistyksen tietosuojavastaavan sähköposti: <a href="mailto:gdpr@salamurhaajat.net">gdpr@salamurhaajat.net</a></li>
      </ul>
    <li>Rekisterin käsittelijät</li>
      <ul>
        <li>Surman ylläpitäjien ja kehittäjien sähköposti: <a href="mailto:surma@salamurhaajat.net">surma@salamurhaajat.net</a></li>
        <li>Salamurhaturnauksen tuomariston sähköposti: <a href="mailto:tuomaristo@salamurhaajat.net">tuomaristo@salamurhaajat.net</a></li>
      </ul>
    </ul>
