  ...
  <div className={`${styles.center} ${styles.main}`}>
    ...
    <Accordion variant="outlined">
      ...
      <h2 className={styles.accordionText}>Mikä on salamurhaturnaus?</h2>
        ...
        <p>Salamurhaturnaukseen osallistuminen aloitetaan ilmoittautumalla peliin Surman kautta, jonka jälkeen Surma ja turnauksen tuomaristo lähettävät lisäohjeita sähköpostilla. </p>
