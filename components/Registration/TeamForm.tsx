    ...
    <Container maxWidth="md">
      {registrationOk ? (
        <div>
          ...
          <p>
            Joukkueesi pelaajille on lähetetty vahvistussähköpostit
            ilmoittautumislomakkeeseen annettuihin osoitteisiin. Samat
            sähköpostiosoitteet toimivat kirjautumistunnuksina Surmaan.
          </p>
          <p>Tarkistattehan roskapostikansionne jos vahvistusviestiä ei näy.</p>
        </div>
      ) : (
        <>
          ...
          <Box sx={{ my: 4 }}>
            ...
            <p>
              Ilmoittautuminen on kaksivaiheinen. Ensimmäisessä vaiheessa
              syöttäkää joukkueenne tiedot eli nimi ja pelaajien yhteystiedot.
              Joukkueen koko on 2-4 pelaajaa. Mukaan voi myös ilmoittautua
              yksin, jolloin tuomaristo määrittää sinulle joukkueen.
            </p>
            <p>
              Näitä tietoja tarvitaan Surmaan kirjautumiseen ja jotta tuomaristo
              voi ottaa pelaajiin yhteyttä turnaukseen liittyvissä asioissa.
            ...
            <p>
              <strong>
                HUOM! Vain yhden joukkueen jäsenen tarvitsee täyttää tämä
                lomake. Lomakkeen lähettämisen jälkeen joukkueen jäsenet
                pystyvät kirjautumaan sovellukseen tässä annetuilla
