  ...
  return (
    <div>
      ...
      <ul>
        <li>Kuva </li>
        <li>Kotiosoite</li>
        <li>Opiskelupaikka </li>
        <li>Aikataulut </li>
        <li>Aikataulut</li>
        <li>
          Ulkonäköön liittyvät tiedot (silmien väri, hiukset, pituus,
          silmälasit, muut ulkonäköön liittyvät tiedot)
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        pelaajat näkevät käyttäjän yhteystiedoista etu-ja sukunimen sekä muut
        tiedot kokonaisuudessaan. Tuomaristolla on pääsy kaikkiin käyttäjän
        syöttämiin tietoihin sekä he näkevät myös milloin tietoja on viimeksi
        muokattu.
      </p>
      ...
      <h3>8. Rekisteröidyn oikeudet</h3>
      <p>
        Euroopan unionin yleinen tietosuoja-asetus (GDPR) antaa käyttäjälle
        oikeuden saada tietää mitä tietoja hänestä on tallennettu rekisteriin,
        oikeuden muokata tietoja tarvittaessa sekä oikeuden tulla unohdetuksi.
        Mikäli pelaaja haluaa kesken turnauksen poistaa pakolliset tietonsa
        tietokannasta, hyväksyy hän samalla, että turnaus päättyy hänen
        osaltaan. Kaikissa omiin tietoihin liittyvissä kysymyksissä ja
        tiedusteluissa voi ottaa yhteyttä rekisterin yhteyshenkilöihin.
      </p>
      <h3>9. Tietojen käsittelyn periaatteet</h3>
      <p>
        Sovelluksen sisältämiä tietoja ei luovuteta kenellekään turnauksen
        ulkopuoliselle henkilölle tai taholle. Tietoja ei myöskään käytetä
        mihinkään turnauksen ulkopuoliseen viestintään. Ainoana poikkeuksena
        tähän on ongelmatilanteet, esimerkiksi häirintätilanteet, jolloin tiedot
        luovutetaan HYSin häirintäyhdyshenkilölle tai HYSin hallitukselle.
      </p>
      <p>
